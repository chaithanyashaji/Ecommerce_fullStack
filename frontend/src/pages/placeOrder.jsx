      ...
      <div className='mt-8'>
        ...
        <div className='mt-12'>
          ...
          <div  className='flex gap-3 flex-col lg:flex-row'>
            <div onClick={()=>setMethod('stripe')} className='flex items-center gap-3 border-3 p-2 px-3 cursor-pointer'>
            ...
            <div onClick={()=>setMethod('cod')} className='flex items-center gap-3 border-3 p-2 px-3 cursor-pointer'>
